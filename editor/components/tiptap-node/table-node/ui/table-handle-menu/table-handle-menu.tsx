...
import { cn, isValidPosition, SR_ONLY } from "@/editor/lib/tiptap-utils"
import type { Orientation } from "@/editor/components/tiptap-node/table-node/lib/tiptap-table-utils"
import { selectCellsByCoords } from "@/editor/components/tiptap-node/table-node/lib/tiptap-table-utils"
...
// --- Tiptap UI ---
import { useTableDuplicateRowColumn } from "@/editor/components/tiptap-node/table-node/ui/table-duplicate-row-column-button"
import { useTableMoveRowColumn } from "@/editor/components/tiptap-node/table-node/ui/table-move-row-column-button"
...
import { useTableHeaderRowColumn } from "@/editor/components/tiptap-node/table-node/ui/table-header-row-column-button"
import { useTableAddRowColumn } from "@/editor/components/tiptap-node/table-node/ui/table-add-row-column-button"
import { useTableDeleteRowColumn } from "@/editor/components/tiptap-node/table-node/ui/table-delete-row-column-button"
import { useTableSortRowColumn } from "@/editor/components/tiptap-node/table-node/ui/table-sort-row-column-button"
...
import { dragEnd } from "@/editor/components/tiptap-node/table-node/extensions/table-handle"
