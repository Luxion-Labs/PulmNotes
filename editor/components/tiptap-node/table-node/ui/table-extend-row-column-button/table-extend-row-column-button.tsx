...
import { useTableHandleState } from "@/editor/components/tiptap-node/table-node/hooks/use-table-handle-state"
...
import {
  ...
  selectLastCell,
  runPreservingCursor,
} from "@/editor/components/tiptap-node/table-node/lib/tiptap-table-utils"
import { cn } from "@/editor/lib/tiptap-utils"

// --- Icons ---
import { PlusSmallIcon } from "@/editor/components/tiptap-icons/plus-small-icon"

// --- Internal ---
import { useTableExtendRowColumnButtonsPositioning } from "@/editor/components/tiptap-node/table-node/ui/table-extend-row-column-button/use-table-extend-row-column"
