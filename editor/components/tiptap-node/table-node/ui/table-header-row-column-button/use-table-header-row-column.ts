...
// --- Icons ---
import { TableHeaderRowIcon } from "@/editor/components/tiptap-icons/table-header-row-icon"
import { TableHeaderColumnIcon } from "@/editor/components/tiptap-icons/table-header-column-icon"
