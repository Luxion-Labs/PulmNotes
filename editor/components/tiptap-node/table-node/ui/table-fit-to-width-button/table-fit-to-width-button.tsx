...
// --- Hooks ---
import { useTableFitToWidth } from "@/editor/components/tiptap-node/table-node/ui/table-fit-to-width-button/use-table-fit-to-width"
import type { UseTableFitToWidthConfig } from "@/editor/components/tiptap-node/table-node/ui/table-fit-to-width-button/use-table-fit-to-width"
