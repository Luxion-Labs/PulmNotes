...
import type { TableHandlesState } from "@/editor/components/tiptap-node/table-node/extensions/table-handle"
import {
  TableHandlePlugin,
  tableHandlePluginKey,
} from "@/editor/components/tiptap-node/table-node/extensions/table-handle/table-handle-plugin"
